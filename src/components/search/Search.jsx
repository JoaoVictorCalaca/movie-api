...
function Search() {
    ...
    return (
        <div className='relative'>
            ...
            <Modal style={{overlay: {backgroundColor: 'rgba(0, 0, 0, 0.75)'}}} isOpen={modalIsOpen} onRequestClose={closeModal} className='flex flex-col gap-3 justify-center bg-blue-950 w-full sm:w-1/2 p-4 rounded-b-lg absolute right-0 top-28 md:top-20'>
